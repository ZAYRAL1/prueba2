...
<HEAD>
    ...
    <div id="verde" style="background-color:white; font-style:Verdana">
        ...
        <div class="productos menu">
            <div class="row">
                <img src="menu.png" height="20px" alt="menu">
            </div>
            <div class="container">
...
<body style="background-color: white">
        ...
        <div id="amarillo" style="background-color:lightblue; font-style:arial">
            <h2>
                ...
                <CENTER><img src="globo-y-bomba-imagen-animada-0009.gif"></CENTER>
        </div>
   ...
   <tr>
    ...
    while($consulta =mysqli_fetch_array($result)){
        ...
        <tr>
           ...
           <td> <BR><form method='post' action='actualizartienda.php'onsubmit='return confirmarActualizar()'> \n
